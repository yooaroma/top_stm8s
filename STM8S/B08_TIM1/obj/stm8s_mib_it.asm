...
_TIM1_UPD_OVF_TRG_BRK_IRQHandler:
	clr	a
	div	x, a
;	./../../mib/stm8s_mib_it.c: 224: irqTim1UpdOvf_CALLBACK();
	call	_irqTim1UpdOvf_CALLBACK
...
_TIM1_CAP_COM_IRQHandler:
	clr	a
	div	x, a
;	./../../mib/stm8s_mib_it.c: 242: irqTim1Cap_CALLBACK();
	call	_irqTim1Cap_CALLBACK
...
_TIM4_UPD_OVF_IRQHandler:
	clr	a
	div	x, a
;	./../../mib/stm8s_mib_it.c: 511: TIM4->SR1 = (uint8_t)(~TIM4_FLAG_UPDATE);
	mov	0x5342+0, #0xfe
;	./../../mib/stm8s_mib_it.c: 512: timIrqMain();  
	call	_timIrqMain
