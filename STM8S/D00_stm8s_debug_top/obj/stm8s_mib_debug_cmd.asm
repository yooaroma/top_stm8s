...
;	./../../mib/stm8s_mib_debug_cmd.c: 262: } // HexToInt.
	...
	addw	sp, #20
	jp	(y)
;	./../../mib/stm8s_mib_debug_cmd.c: 272: int DecToLong(char *s, long *retval)
;	-----------------------------------------
;	 function DecToLong
;	-----------------------------------------
_DecToLong:
	sub	sp, #14
	exgw	x, y
;	./../../mib/stm8s_mib_debug_cmd.c: 275: if (!s || !s[0])
	tnzw	y
	jreq	00101$
	ld	a, (y)
	jrne	00102$
00101$:
;	./../../mib/stm8s_mib_debug_cmd.c: 276: return FALSE;
	clrw	x
	jra	00111$
00102$:
;	./../../mib/stm8s_mib_debug_cmd.c: 278: for (*retval = 0; *s; s++)
	ldw	x, (0x11, sp)
	ldw	(0x01, sp), x
	clr	(0x3, x)
	clr	(0x2, x)
...
00109$:
	ld	a, (y)
	jreq	00107$
;	./../../mib/stm8s_mib_debug_cmd.c: 280: if (*s < '0' || *s > '9')
	cp	a, #0x30
	jrc	00104$
	cp	a, #0x39
	jrule	00105$
00104$:
;	./../../mib/stm8s_mib_debug_cmd.c: 281: return FALSE;
	clrw	x
	jra	00111$
00105$:
;	./../../mib/stm8s_mib_debug_cmd.c: 282: remainder = *s - '0';
	clrw	x
	ld	xl, a
	subw	x, #0x0030
	ldw	(0x05, sp), x
	...
	ld	(0x04, sp), a
	ld	(0x03, sp), a
;	./../../mib/stm8s_mib_debug_cmd.c: 283: *retval = *retval * 10 + remainder;
	ldw	x, (0x01, sp)
	ld	a, (0x3, x)
	ld	(0x0e, sp), a
	ld	a, (0x2, x)
...
;	./../../mib/stm8s_mib_debug_cmd.c: 278: for (*retval = 0; *s; s++)
	...
	jra	00109$
00107$:
;	./../../mib/stm8s_mib_debug_cmd.c: 286: return TRUE;
	clrw	x
	incw	x
00111$:
;	./../../mib/stm8s_mib_debug_cmd.c: 287: } // DecToLong.
	addw	sp, #14
	popw	y
	addw	sp, #2
	jp	(y)
;	./../../mib/stm8s_mib_debug_cmd.c: 296: void HexDump(uint32_t addr, uint32_t len)
;	-----------------------------------------
;	 function HexDump
;	-----------------------------------------
_HexDump:
	sub	sp, #39
;	./../../mib/stm8s_mib_debug_cmd.c: 299: uint32_t endPtr = (addr + len);
	ldw	y, (0x2c, sp)
	addw	y, (0x30, sp)
	ldw	x, (0x2a, sp)
	jrnc	00240$
...
00240$:
	...
	ldw	(0x17, sp), y
	ldw	(0x15, sp), x
;	./../../mib/stm8s_mib_debug_cmd.c: 300: int i, remainder = len & 0xf;
	ldw	x, (0x30, sp)
	ld	a, xl
	and	a, #0x0f
	ld	(0x1a, sp), a
	clr	(0x19, sp)
;	./../../mib/stm8s_mib_debug_cmd.c: 306: mib_printf("\r\n");
	push	#<(___str_0+0)
	push	#((___str_0+0) >> 8)
	call	_mib_printf
	addw	sp, #2
;	./../../mib/stm8s_mib_debug_cmd.c: 307: mib_printf("address     Hex Value                                        Ascii value\r\n");
	push	#<(___str_3+0)
	push	#((___str_3+0) >> 8)
	call	_mib_printf
	addw	sp, #2
;	./../../mib/stm8s_mib_debug_cmd.c: 310: p_address = (uint32_t)(addr);
	ldw	x, (0x2c, sp)
	ldw	y, (0x2a, sp)
;	./../../mib/stm8s_mib_debug_cmd.c: 311: p_data_ptr = (uint16_t *)p_data;
;	./../../mib/stm8s_mib_debug_cmd.c: 312: while ((p_address + 16) <= endPtr)
	ldw	(0x1d, sp), x
	ldw	(0x1b, sp), y
00107$:
	ldw	x, (0x1d, sp)
	...
	jp	00163$
00241$:
;	./../../mib/stm8s_mib_debug_cmd.c: 314: mib_printf("0x%08lx : ", p_address);
	ldw	x, (0x1d, sp)
	pushw	x
	ldw	x, (0x1d, sp)
	pushw	x
	...
	call	_mib_printf
	addw	sp, #6
;	./../../mib/stm8s_mib_debug_cmd.c: 315: for (i = 0; i < 8; i++)
	clrw	x
	ldw	(0x26, sp), x
00120$:
;	./../../mib/stm8s_mib_debug_cmd.c: 317: p_data_ptr[i] = rd_ADDR16(p_address + i * 2);
	ldw	y, (0x26, sp)
	sllw	y
	ldw	x, y
	pushw	x
	...
	ldw	y, (y)
	ldw	(x), y
;	./../../mib/stm8s_mib_debug_cmd.c: 318: mib_printf("%02x ", p_data[i * 2]);
	ld	a, (0x27, sp)
	sll	a
	ld	(0x23, sp), a
	ld	(0x25, sp), a
	...
	call	_mib_printf
	addw	sp, #4
;	./../../mib/stm8s_mib_debug_cmd.c: 319: mib_printf("%02x ", p_data[i * 2 + 1]);
	ld	a, (0x23, sp)
	inc	a
	ld	(0x25, sp), a
	rlc	a
...
;	./../../mib/stm8s_mib_debug_cmd.c: 315: for (i = 0; i < 8; i++)
	...
	cpw	x, #0x0008
	jrslt	00120$
;	./../../mib/stm8s_mib_debug_cmd.c: 321: mib_printf(" ");
	push	#<(___str_6+0)
	push	#((___str_6+0) >> 8)
	call	_mib_printf
	addw	sp, #2
;	./../../mib/stm8s_mib_debug_cmd.c: 322: for (i = 0; i < 16; i++)
	clrw	x
	ldw	(0x26, sp), x
00122$:
;	./../../mib/stm8s_mib_debug_cmd.c: 324: c = p_data[i];
	ldw	x, sp
	incw	x
	addw	x, (0x26, sp)
	ld	a, (x)
;	./../../mib/stm8s_mib_debug_cmd.c: 325: if (c >= 32 && c <= 125)
	cp	a, #0x20
	jrc	00103$
	cp	a, #0x7d
	jrugt	00103$
;	./../../mib/stm8s_mib_debug_cmd.c: 326: mib_printf("%c", c);
	clrw	x
	ld	xl, a
	pushw	x
	push	#<(___str_7+0)
	...
	jra	00123$
00103$:
;	./../../mib/stm8s_mib_debug_cmd.c: 328: mib_printf(".");
	push	#<(___str_8+0)
	push	#((___str_8+0) >> 8)
	call	_mib_printf
	addw	sp, #2
...
;	./../../mib/stm8s_mib_debug_cmd.c: 322: for (i = 0; i < 16; i++)
	...
	cpw	x, #0x0010
	jrslt	00122$
;	./../../mib/stm8s_mib_debug_cmd.c: 330: p_address += 16;
	ldw	y, (0x21, sp)
	ldw	(0x1d, sp), y
	ldw	y, (0x1f, sp)
	ldw	(0x1b, sp), y
;	./../../mib/stm8s_mib_debug_cmd.c: 332: mib_printf("\r\n");
	push	#<(___str_0+0)
	push	#((___str_0+0) >> 8)
	call	_mib_printf
	addw	sp, #2
...
00163$:
	...
	ldw	y, (0x1b, sp)
	ldw	(0x22, sp), y
;	./../../mib/stm8s_mib_debug_cmd.c: 336: if (remainder)
	ldw	x, (0x19, sp)
	jrne	00248$
	jp	00119$
00248$:
;	./../../mib/stm8s_mib_debug_cmd.c: 338: mib_printf("0x%08lx  ", p_address);
	ldw	x, (0x1d, sp)
	pushw	x
	ldw	x, (0x1d, sp)
	pushw	x
	...
	call	_mib_printf
	addw	sp, #6
;	./../../mib/stm8s_mib_debug_cmd.c: 339: for (i = 0; i < (remainder >> 1); i++)
	ldw	x, (0x19, sp)
	sraw	x
	ldw	(0x1d, sp), x
	clrw	x
...
00125$:
	...
	cpw	x, (0x1d, sp)
	jrsge	00110$
;	./../../mib/stm8s_mib_debug_cmd.c: 341: p_data_ptr[i] = rd_ADDR16(p_address + i * 2);
	ldw	y, (0x26, sp)
	sllw	y
	ldw	x, y
	pushw	x
	...
	ldw	y, (y)
	ldw	(x), y
;	./../../mib/stm8s_mib_debug_cmd.c: 342: mib_printf("%02x ", p_data[i * 2]);
	ld	a, (0x27, sp)
	sll	a
	ld	(0x1f, sp), a
	ld	(0x21, sp), a
	...
	call	_mib_printf
	addw	sp, #4
;	./../../mib/stm8s_mib_debug_cmd.c: 343: mib_printf("%02x ", p_data[i * 2 + 1]);
	ld	a, (0x1f, sp)
	inc	a
	ld	(0x21, sp), a
	rlc	a
...
;	./../../mib/stm8s_mib_debug_cmd.c: 339: for (i = 0; i < (remainder >> 1); i++)
	...
	jra	00125$
00110$:
;	./../../mib/stm8s_mib_debug_cmd.c: 345: for (i = 0; i < (16 - (remainder >> 1) * 2); i++)
	ldw	x, (0x1d, sp)
	sllw	x
	ldw	(0x26, sp), x
	ld	a, #0x10
...
00128$:
	...
	cpw	x, (0x24, sp)
	jrsge	00111$
;	./../../mib/stm8s_mib_debug_cmd.c: 347: mib_printf("   ");
	push	#<(___str_10+0)
	push	#((___str_10+0) >> 8)
	call	_mib_printf
	addw	sp, #2
;	./../../mib/stm8s_mib_debug_cmd.c: 345: for (i = 0; i < (16 - (remainder >> 1) * 2); i++)
	...
	jra	00128$
00111$:
;	./../../mib/stm8s_mib_debug_cmd.c: 349: mib_printf(" ");
	push	#<(___str_6+0)
	push	#((___str_6+0) >> 8)
	call	_mib_printf
	addw	sp, #2
;	./../../mib/stm8s_mib_debug_cmd.c: 350: for (i = 0; i < remainder; i++)
	clrw	x
	ldw	(0x26, sp), x
00131$:
	ldw	x, (0x26, sp)
	cpw	x, (0x19, sp)
	jrsge	00116$
;	./../../mib/stm8s_mib_debug_cmd.c: 352: c = p_data[i];
	ldw	x, sp
	incw	x
	addw	x, (0x26, sp)
	ld	a, (x)
;	./../../mib/stm8s_mib_debug_cmd.c: 353: if (c >= 32 && c <= 125)
	cp	a, #0x20
	jrc	00113$
	cp	a, #0x7d
	jrugt	00113$
;	./../../mib/stm8s_mib_debug_cmd.c: 354: mib_printf("%c", c);
	clrw	x
	ld	xl, a
	pushw	x
	push	#<(___str_7+0)
	...
	jra	00132$
00113$:
;	./../../mib/stm8s_mib_debug_cmd.c: 356: mib_printf(".");
	push	#<(___str_8+0)
	push	#((___str_8+0) >> 8)
	call	_mib_printf
	addw	sp, #2
...
;	./../../mib/stm8s_mib_debug_cmd.c: 350: for (i = 0; i < remainder; i++)
	...
	jra	00131$
00116$:
;	./../../mib/stm8s_mib_debug_cmd.c: 358: for (i = 0; i < (16 - remainder); i++)
	ld	a, #0x10
	sub	a, (0x1a, sp)
	ld	(0x25, sp), a
	clr	a
...
00134$:
	...
	cpw	x, (0x24, sp)
	jrsge	00117$
;	./../../mib/stm8s_mib_debug_cmd.c: 360: mib_printf(" ");
	push	#<(___str_6+0)
	push	#((___str_6+0) >> 8)
	call	_mib_printf
	addw	sp, #2
...
;	./../../mib/stm8s_mib_debug_cmd.c: 363: mib_printf("\r\n");
	...
	addw	sp, #2
00119$:
;	./../../mib/stm8s_mib_debug_cmd.c: 365: return;
;	./../../mib/stm8s_mib_debug_cmd.c: 366: } // HexDump.
	ldw	x, (40, sp)
	addw	sp, #49
	jp	(x)
;	./../../mib/stm8s_mib_debug_cmd.c: 375: int DoPrintHelp(int argc, char **argv)
;	-----------------------------------------
;	 function DoPrintHelp
;	-----------------------------------------
_DoPrintHelp:
	sub	sp, #2
;	./../../mib/stm8s_mib_debug_cmd.c: 379: if (argc == 1)
	decw	x
	jrne	00105$
;	./../../mib/stm8s_mib_debug_cmd.c: 381: mib_printf("*******\r\n");
	push	#<(___str_11+0)
	push	#((___str_11+0) >> 8)
	call	_mib_printf
	addw	sp, #2
;	./../../mib/stm8s_mib_debug_cmd.c: 382: mib_printf("  help  Help for commands.\r\n");
	push	#<(___str_12+0)
	push	#((___str_12+0) >> 8)
	call	_mib_printf
	addw	sp, #2
;	./../../mib/stm8s_mib_debug_cmd.c: 384: for (cptr = cmdTbl; cptr->cmd; cptr++)
	ldw	x, #(_cmdTbl+0)
	ldw	(0x01, sp), x
00108$:
	ldw	x, (0x01, sp)
	ldw	x, (x)
	jreq	00103$
;	./../../mib/stm8s_mib_debug_cmd.c: 386: if (cptr->usage)
	ldw	x, (0x01, sp)
	ldw	x, (0x4, x)
	jreq	00109$
;	./../../mib/stm8s_mib_debug_cmd.c: 387: MibWriteDebugString(cptr->usage);
	call	_MibWriteDebugString
00109$:
;	./../../mib/stm8s_mib_debug_cmd.c: 384: for (cptr = cmdTbl; cptr->cmd; cptr++)
	ldw	x, (0x01, sp)
	...
	jra	00108$
00103$:
;	./../../mib/stm8s_mib_debug_cmd.c: 389: mib_printf("*******\r\n");
	push	#<(___str_11+0)
	push	#((___str_11+0) >> 8)
	call	_mib_printf
	addw	sp, #2
	jra	00106$
00105$:
;	./../../mib/stm8s_mib_debug_cmd.c: 393: mib_printf("\tUnknown command : ");
	push	#<(___str_13+0)
	push	#((___str_13+0) >> 8)
	call	_mib_printf
	addw	sp, #2
;	./../../mib/stm8s_mib_debug_cmd.c: 394: mib_printf("%s", argv[0]);
	ldw	x, (0x05, sp)
	ldw	x, (x)
	pushw	x
	push	#<(___str_14+0)
	...
	call	_mib_printf
	addw	sp, #4
;	./../../mib/stm8s_mib_debug_cmd.c: 395: mib_printf("\r\n");
	push	#<(___str_0+0)
	push	#((___str_0+0) >> 8)
	call	_mib_printf
	addw	sp, #2
00106$:
;	./../../mib/stm8s_mib_debug_cmd.c: 397: return TRUE;
	clrw	x
	incw	x
;	./../../mib/stm8s_mib_debug_cmd.c: 398: }
	addw	sp, #2
	popw	y
	addw	sp, #2
	jp	(y)
;	./../../mib/stm8s_mib_debug_cmd.c: 408: int getdec(uint8_t **ptr)
;	-----------------------------------------
;	 function getdec
;	-----------------------------------------
_getdec:
	sub	sp, #6
;	./../../mib/stm8s_mib_debug_cmd.c: 410: uint8_t *p = *ptr;
	ldw	(0x05, sp), x
	ldw	x, (x)
	ldw	(0x01, sp), x
;	./../../mib/stm8s_mib_debug_cmd.c: 411: int ret = 0;
	clrw	x
	ldw	(0x03, sp), x
;	./../../mib/stm8s_mib_debug_cmd.c: 412: if ((*p < '0') || (*p > '9'))
	ldw	x, (0x01, sp)
	ld	a, (x)
	cp	a, #0x30
	jrc	00101$
	...
	jrule	00113$
00101$:
;	./../../mib/stm8s_mib_debug_cmd.c: 413: return (-1);
	clrw	x
	decw	x
	jra	00108$
;	./../../mib/stm8s_mib_debug_cmd.c: 414: while ((*p >= '0') && (*p <= '9'))
00113$:
	ldw	y, (0x01, sp)
00105$:
	ld	a, (y)
	...
	cp	a, #0x39
	jrugt	00107$
;	./../../mib/stm8s_mib_debug_cmd.c: 416: ret = ret * 10 + (int)(*p - '0');
	ldw	x, (0x03, sp)
	sllw	x
	sllw	x
	addw	x, (0x03, sp)
	...
	addw	x, (0x03, sp)
	ldw	(0x03, sp), x
;	./../../mib/stm8s_mib_debug_cmd.c: 417: p++;
	incw	y
	jra	00105$
00107$:
;	./../../mib/stm8s_mib_debug_cmd.c: 419: *ptr = p;
	ldw	x, (0x05, sp)
	ldw	(x), y
;	./../../mib/stm8s_mib_debug_cmd.c: 420: return (ret);
	ldw	x, (0x03, sp)
00108$:
;	./../../mib/stm8s_mib_debug_cmd.c: 421: }
	addw	sp, #6
	ret
	.area CODE
	.area CONST
